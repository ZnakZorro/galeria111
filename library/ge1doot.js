...
ge1doot.Pointer = function (setup) {
	...
	this.pointerDown = function (e) {
		...
		this.hasMoved = false;
		this.isDown = true;
		this.X = sX = (e.clientX !== undefined ? e.clientX : e.touches[0].clientX) - this.screen.left;
		this.Y = sY = (e.clientY !== undefined ? e.clientY : e.touches[0].clientY) - this.screen.top + ((html && html.scrollTop) || body.scrollTop);
		this.setup.down && this.setup.down(e);
	}
	this.pointerMove = function(e) {
		this.X = (e.clientX !== undefined ? e.clientX : e.touches[0].clientX) - this.screen.left;
		this.Y = (e.clientY !== undefined ? e.clientY : e.touches[0].clientY) - this.screen.top + ((html && html.scrollTop) || body.scrollTop);
		if (this.isDown) {
